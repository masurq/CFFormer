...
class DualPyramidVisionTransformerV2(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dims=[64, 128, 256, 512],
                 ...
                 sr_ratios=[8, 4, 2, 1], num_stages=4, linear=False, norm_fuse=nn.BatchNorm2d):
        super().__init__()
        self.depths = depths
...
class pvt_v2_b0(DualPyramidVisionTransformerV2):
...
class pvt_v2_b1(DualPyramidVisionTransformerV2):
    def __init__(self, **kwargs):
...
class pvt_v2_b2(DualPyramidVisionTransformerV2):
    def __init__(self, **kwargs):
...
class pvt_v2_b2_li(DualPyramidVisionTransformerV2):
    def __init__(self, **kwargs):
...
class pvt_v2_b3(DualPyramidVisionTransformerV2):
    def __init__(self, **kwargs):
...
class pvt_v2_b4(DualPyramidVisionTransformerV2):
    def __init__(self, **kwargs):
...
class pvt_v2_b5(DualPyramidVisionTransformerV2):
    def __init__(self, **kwargs):
