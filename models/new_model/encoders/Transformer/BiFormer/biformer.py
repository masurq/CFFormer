...
class BiFormer(nn.Module):
    ...
    def forward_features(self, x1, x2):
        ...
        for i in range(4):
            ...
            x_1 = self.norm[i](x.permute(0, 2, 3, 1).contiguous())
...
def load_path_model(model, model_file, is_restore=False):
    # load raw state_dict
    t_start = time.time()
