...
# 设置训练日志
C.log_path = '/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/ZMSegmentationPlus-1.1/logs/whu_sar_opt512/pred_vis'  # ablation_experiments
C.env = 'all_train'
C.log_append = False
...
C.in_channel2 = 1
C.use_amp = False
C.backbone = 'biformer_t'
C.pretrained_model = "/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/pre_trained/biformer/biformer_tiny_best.pth"
...
C.model_path = '/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/checkpoints/whu_sar_opt512/MLPAlignDecoder_biformer_t/512_all/08-26-18-30-01/MLPAlignDecoder_biformer_t_512_all_epoch56.pth'  # 53 48 54
C.pred_path = '/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/ZMSegmentationPlus-1.1/pred_results/whu_sar_opt/small/new_model_tiny'
...
C.train_data_root = '/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/run_data/whu_sar_opt512/all_train'
C.val_data_root = '/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/run_data/whu_sar_opt512/val'
C.test_data_root = '/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/run_data/whu_sar_opt512/test/cut'
...
C.save_root = '/media/ubuntu/7c2c9e84-2646-43cd-8669-ef651d32fd3b/zm/ZMSeg/checkpoints/whu_sar_opt512/comparative2'
